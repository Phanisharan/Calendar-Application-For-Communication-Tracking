...
const Notifications = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8000/admin-module/communications/overdue/')
      .then(response => {
    ...
    axios.get('http://localhost:8000/admin-module/communications/due-today/')
      .then(response => {
  ...
  const handleCommunicationSubmit = (data) => {
    axios.post('http://localhost:8000/admin-module/communications/', {
      ...data,
