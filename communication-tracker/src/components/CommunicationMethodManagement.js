...
const CommunicationMethodManagement = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:8000/admin-module/methods/')
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const url = isEdit
      ? `http://localhost:8000/admin-module/methods/${selectedMethod.id}/`
      : 'http://localhost:8000/admin-module/methods/';
  ...
  const handleDelete = (id) => {
    axios
      .delete(`http://localhost:8000/admin-module/methods/${id}/`)
