...
const CompanyManagement = () => {
  ...
  const handleSubmit = (data) => {
    ...
    const url = isEdit
      ? `http://localhost:8000/admin-module/companies/${selectedCompany.id}/`
      : 'http://localhost:8000/admin-module/companies/';
  ...
  const handleDelete = (id) => {
    axios
      .delete(`http://localhost:8000/admin-module/companies/${id}/`)
